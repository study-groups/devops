...
_tsm_init_prehooks() {
    # Python: use tetra's pyenv with proper initialization
    TSM_PREHOOKS[python]='export PYENV_ROOT="$HOME/tetra/pyenv"; export PATH="$PYENV_ROOT/bin:$PATH"; eval "$(pyenv init -)"'
