...
# Export functions
export -f cdp_save_session
export -f cdp_load_session
export -f cdp_get_session_state_file
export -f cdp_is_connected
export -f cdp_get_session_id
export -f cdp_get_session_ws_url
export -f cdp_get_session_chrome_pid
export -f cdp_update_session_field
export -f cdp_mark_connected
export -f cdp_mark_disconnected
export -f cdp_clear_session
export -f cdp_get_session_metadata
export -f cdp_set_session_metadata
