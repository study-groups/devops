...
tds_theme_arctic() {
    # Theme metadata
    THEME_NAME="arctic"
    THEME_DESCRIPTION="Arctic blue/cyan - icy cool temperature"
    ...
    # Background anchor - deep slate (icy dark)
    BACKGROUND="0F172A"

    # Surface tint - subtle cool undertone
    TINT=8
