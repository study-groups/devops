...
/**
 * Log Debug Tools
 * Client-side debugging utilities for log display
 * Usage: window.APP.debug.log.analyze()
 */

console.log('📝 LOG DEBUG TOOLS LOADED');
...
.log-entry {
    ...
    analyze() {
        ...
        if (summary.alignmentIssues > 0) {
            ...
            console.log('\n💡 Run APP.debug.log.applyLeftAlignmentFix() to apply alignment');
        }
    ...
    test: {
        ...
        toggleAlignment() {
            ...
            if (existingFix) {
                ...
                window.APP.debug.log.applyLeftAlignmentFix();
...
console.log('  APP.debug.log.analyze() - Run full analysis');
console.log('  APP.debug.log.analyzeColumnWidths() - Check column widths');
console.log('  APP.debug.log.applyColumnWidthFix() - Apply column width adjustments');
console.log('  APP.debug.log.addDebugBorders() - Add colored borders to see columns');
console.log('  APP.debug.log.visualTest() - Visual test with borders and measurements');
console.log('  APP.debug.log.test.addTestEntry() - Add test entry');
console.log('  APP.debug.log.test.toggleAlignment() - Toggle alignment');

// Export for module use
export const logDebugTools = window.APP.debug.log;
