/**
 * pjaSdk.js - PJA Games SDK (Non-Module Version)
 * 
 * This file restores the original PJA SDK functionality for games that
 * include the SDK via <script> tag rather than ES modules.
 * 
 * This provides the same initializeGameClient function that was removed
 * during the logging system refactor.
 */
...
// Legacy PJA SDK namespace for backward compatibility
window.pjaSdk = {
...
console.log('[pjaSdk.js] PJA Games SDK loaded - initializeGameClient restored'); 