    ...
    async initializeDomInspector() {
        try {
            ...
            if (this.domInspector) {
                ...
                console.log('[DomInspectorDebugPanel] DOM Inspector initialized successfully');
            } else {
                this.updateStatus('Failed to initialize');
                console.error('[DomInspectorDebugPanel] Failed to initialize DOM Inspector');
            }
        } catch (error) {
            this.updateStatus('Error: ' + error.message);
            console.error('[DomInspectorDebugPanel] Error initializing DOM Inspector:', error);
        }
    }
