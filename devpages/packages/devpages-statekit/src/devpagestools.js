/**
 * DevpagesTools middleware for StateKit
...
/**
 * Creates a DevpagesTools middleware
 * @param {object} options - DevpagesTools options
 * @returns {Function} DevpagesTools middleware
 */
export function createDevpagesTools(options = {}) {
    const {
        name = 'StateKit DevpagesTools',
    ...
    // Create the DevpagesTools instance
    const devTools = {
        // Public API
        ...
        emit: (event, data) => {
            devTools.listeners.forEach(listener => {
                try {
                    ...
                    console.error('[DevpagesTools] Listener error:', error);
                }
            });
        },
        subscribe: (listener) => {
    ...
    // Expose DevpagesTools on window for browser console access
...
/**
 * Creates a DevpagesTools panel for browser console
 * @param {object} devTools - DevpagesTools instance
 * @returns {object} Console panel API
 */
export function createDevpagesConsolePanel(devTools) {
    const panel = {
        showHistory: () => {
...
/**
 * Creates a simple DevpagesTools UI component
 * @param {object} devTools - DevpagesTools instance
 * @param {HTMLElement} container - Container element
 * @returns {object} UI component
 */
export function createDevpagesToolsUI(devTools, container) {
    const ui = {
        container,
        devTools,
        isVisible: false,
            ...
            container.innerHTML = `
                ...
                ">
                    <div style="
                        ...
                        align-items: center;
                    ">
                        <strong>StateKit DevpagesTools</strong>
